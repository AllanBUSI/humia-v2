...
export function TemplateIcon({ className, ...props }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} {...props}>
...
const FEATURE_ICON_COMPONENTS: Record<string, React.ComponentType<IconProps>> = {
...
export function FeatureIcon({ name, className }: { name: string; className?: string }) {
  const Component = FEATURE_ICON_COMPONENTS[name];
